...
<body class="bg-dark">
	<span class="text-base text-slate-200">Jumlah Pengunjung : <?= $visitor ?></span>
	<?php if (isset($waktu)) : ?>
		<span class="text-base text-slate-200">Anda Mengunjungi Pada : <?= $waktu ?></span>
	<?php endif; ?>
	<!-- Header Start -->
	...
	<section id="home" class="pt-36">
		<div class="container">
			<div class="flex flex-wrap">
				<div class="w-full self-center px-4 lg:w-1/2" data-aos="fade-right" data-aos-duration="1500">
				...
				<div class="w-full self-end px-4 lg:w-1/2" data-aos="fade-left" data-aos-duration="1500">
					<div class="mt-10 relative lg:mt-9 lg:right-0">
						<img src="<?= base_url('vendor/portfolio/dist/img/' . $hero_section->photo_profile) ?>" alt="Profile Picture" class="max-w-full mx-auto" id="profile-picture" />
	...
	<section id="about" class="pt-36 pb-32">
		<div class="container">
			<div class="flex flex-wrap">
				<div class="w-full px-4 mb-10 lg:w-1/2" data-aos="fade-right" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
					<h4 class="font-bold uppercase text-primary text-lg">Tentang Saya</h4>
					<?= $about_section_left->title; ?>
					<?= $about_section_left->content; ?>
				</div>
				<div class="w-full px-4 lg:w-1/2" data-aos="fade-left" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
					<?= $about_section_right->title; ?>
					<?= $about_section_right->content; ?>
					<?= $about_section_right->extention; ?>`
				</div>
			</div>
		</div>
	</section>
	...
	<section id="portfolio" class="pt-36 pb-16 bg-slate-700">
		<div class="container">
			<div class="w-full px-4" data-aos="zoom-in" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
			...
			<div class="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
				<?php foreach ($portfolio_section as $a) : ?>
					<div class="mb-12 p-4 md:w-1/2" data-aos="zoom-in" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
						<div class="rounded-md shadow-md overflow-hidden">
							<img src="<?= base_url('vendor/portfolio/dist/img/portfolio/' . $a->img) ?>" alt="E-SDM" width="w-full" />
						</div>
						<h3 class="font-semibold text-xl text-slate-200 mt-5"><?= $a->title ?></h3>
						<p class="font-medium text-base text-secondary text-justify"><?= $a->content ?></p>
					</div>
				<?php endforeach; ?>
			</div>
		</div>
	...
	<section id="contact" class="pt-36 pb-32">
		<div class="container">
			<div class="w-full px-4" data-aos="zoom-in-down" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
				<div class="max-w-xl mx-auto text-center mb-16">
			...
			<div class="flex flex-wrap">
				<div class="w-full px-4 lg:w-1/2" data-aos="zoom-in-right" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
					<img src="<?= base_url('vendor/portfolio/') ?>dist/img/emailme.png" alt="Email Me" width="w-full" id="email-me" />
				</div>

				<div class="w-full lg:w-1/2 lg:mx-auto" data-aos="zoom-in-left" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
					<form action="mailto:muhammadnuzril2325@gmail.com" method="post" enctype="text/plain">
						...
						<div class="w-full px-4 mb-8">
							...
							<input type="email" id="email" name="mail" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary" required />
						</div>
						<div class="w-full px-4 mb-8">
							<label for="message" class="text-base font-bold text-primary">Pesan</label>
							<textarea id="message" name="comment" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary h-32" required></textarea>
						</div>
	...
	<footer class="bg-slate-700 pt-24 pb-12">
		<div class="container">
			...
			<div class="w-full pt-10 border-t border-slate-400">
				...
				<p class="font-medium text-sm text-slate-400 text-center">Crafted by <span class="text-primary font-semibold">nuz's</span> with <span class="text-red-700">❤</span></p>
